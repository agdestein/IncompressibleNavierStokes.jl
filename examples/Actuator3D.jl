...
plotter = RealTimePlotter(; nupdate = 5, fieldname = :velocity, type = contour)
...
V, p = @time solve(problem, RK44P2(); inplace = true, Δt = 4π / 200, processors, pressure_solver);
