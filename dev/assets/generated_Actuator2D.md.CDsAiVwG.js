import{_ as s,c as a,o as t,a6 as n}from"./chunks/framework.B8Zg0AH8.js";const i="/agdestein.github.io/IncompressibleNavierStokes.jl/dev/assets/ltixhbo.MCdy6iP9.png",p="/agdestein.github.io/IncompressibleNavierStokes.jl/dev/assets/xifqgxg.SPjrjP5G.png",l="/agdestein.github.io/IncompressibleNavierStokes.jl/dev/assets/uqanjdw.BhXrGMYg.png",e="/agdestein.github.io/IncompressibleNavierStokes.jl/dev/assets/rfmygrx.DAvCPa44.png",F=JSON.parse('{"title":"Unsteady actuator case - 2D","description":"","frontmatter":{},"headers":[],"relativePath":"generated/Actuator2D.md","filePath":"generated/Actuator2D.md","lastUpdated":null}'),h={name:"generated/Actuator2D.md"},k=n(`<h1 id="Unsteady-actuator-case-2D" tabindex="-1">Unsteady actuator case - 2D <a class="header-anchor" href="#Unsteady-actuator-case-2D" aria-label="Permalink to &quot;Unsteady actuator case - 2D {#Unsteady-actuator-case-2D}&quot;">​</a></h1><p>In this example, an unsteady inlet velocity profile at encounters a wind turbine blade in a wall-less domain. The blade is modeled as a uniform body force on a thin rectangle.</p><p>We start by loading packages. A <a href="https://github.com/JuliaPlots/Makie.jl" target="_blank" rel="noreferrer">Makie</a> plotting backend is needed for plotting. <code>GLMakie</code> creates an interactive window (useful for real-time plotting), but does not work when building this example on GitHub. <code>CairoMakie</code> makes high-quality static vector-graphics plots.</p><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">using</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> CairoMakie</span></span>
...
<span class="line"><span>Iteration 240	t = 12	Δt = 0.05	umax = 1.02848</span></span></code></pre></div><h2 id="Post-process" tabindex="-1">Post-process <a class="header-anchor" href="#Post-process" aria-label="Permalink to &quot;Post-process {#Post-process}&quot;">​</a></h2><p>We may visualize or export the computed fields <code>(u, p)</code>.</p><p>Export to VTK</p><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">save_vtk</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(setup, state</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">.</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">u, state</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">.</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">t, </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&quot;</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">$output</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">/solution&quot;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">)</span></span></code></pre></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>1-element Vector{String}:</span></span>
