import{_ as n,c as a,ai as p,o as l}from"./chunks/framework.BQ_0h9Ot.js";const b=JSON.parse('{"title":"Package versions","description":"","frontmatter":{},"headers":[],"relativePath":"about/versions.md","filePath":"about/versions.md","lastUpdated":null}'),e={name:"about/versions.md"};function i(c,s,v,t,r,d){return l(),a("div",null,s[0]||(s[0]=[p(`<h1 id="Package-versions" tabindex="-1">Package versions <a class="header-anchor" href="#Package-versions" aria-label="Permalink to &quot;Package versions {#Package-versions}&quot;">​</a></h1><h2 id="Julia-version" tabindex="-1">Julia version <a class="header-anchor" href="#Julia-version" aria-label="Permalink to &quot;Julia version {#Julia-version}&quot;">​</a></h2><p>The examples were generated with the following Julia version:</p><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">using</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> InteractiveUtils</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">InteractiveUtils</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">.</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">versioninfo</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">()</span></span></code></pre></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>Julia Version 1.11.3</span></span>
...
<span class="line"><span>  [47edcb42] ADTypes v1.12.0</span></span>
...
<span class="line"><span>  [7d9f7c33] Accessors v0.1.41</span></span>
...
<span class="line"><span>  [dce04be8] ArgCheck v2.4.0</span></span>
<span class="line"><span>  [4fba245c] ArrayInterface v7.18.0</span></span>
<span class="line"><span>  [a9b6321e] Atomix v1.0.1</span></span>
...
<span class="line"><span>  [13f3f980] CairoMakie v0.13.1</span></span>
<span class="line"><span>  [082447d4] ChainRules v1.72.2</span></span>
...
<span class="line"><span>  [35d6a980] ColorSchemes v3.28.0</span></span>
<span class="line"><span>  [3da002f7] ColorTypes v0.12.0</span></span>
...
<span class="line"><span>  [b0b7db55] ComponentArrays v0.15.22</span></span>
...
<span class="line"><span>  [2b5f629d] DiffEqBase v6.161.0</span></span>
...
<span class="line"><span>  [31c24e10] Distributions v0.25.117</span></span>
...
<span class="line"><span>  [4710194d] DocumenterVitepress v0.1.6</span></span>
<span class="line"><span>  [4e289a0a] EnumX v1.0.4</span></span>
<span class="line"><span>  [7da242da] Enzyme v0.13.28</span></span>
...
<span class="line"><span>⌅ [6b7a57c9] Expronicon v0.8.5</span></span>
...
<span class="line"><span>  [a4df4552] FastPower v1.1.1</span></span>
...
<span class="line"><span>  [e9467ef8] GLMakie v0.11.2</span></span>
<span class="line"><span>  [0c68f7d7] GPUArrays v11.2.1</span></span>
<span class="line"><span>  [46192b85] GPUArraysCore v0.2.0</span></span>
<span class="line"><span>  [61eb1bfa] GPUCompiler v1.1.0</span></span>
<span class="line"><span>  [68eda718] GeoFormatTypes v0.4.4</span></span>
<span class="line"><span>  [cf35fbd7] GeoInterface v1.4.1</span></span>
<span class="line"><span>  [5c1252a2] GeometryBasics v0.5.1</span></span>
...
<span class="line"><span>  [d1acc4aa] IntervalArithmetic v0.22.21</span></span>
...
<span class="line"><span>  [033835bb] JLD2 v0.5.11</span></span>
...
<span class="line"><span>  [63c18a36] KernelAbstractions v0.9.32</span></span>
...
<span class="line"><span>  [b2108857] Lux v1.5.2</span></span>
<span class="line"><span>  [bb33d45b] LuxCore v1.2.2</span></span>
<span class="line"><span>  [82251201] LuxLib v1.5.0</span></span>
<span class="line"><span>  [7e8f7934] MLDataDevices v1.6.8</span></span>
<span class="line"><span>  [d8e11817] MLStyle v0.4.17</span></span>
<span class="line"><span>  [f1d291b0] MLUtils v0.4.5</span></span>
<span class="line"><span>  [1914dd2f] MacroTools v0.5.15</span></span>
<span class="line"><span>  [ee78f7c6] Makie v0.22.1</span></span>
<span class="line"><span>  [20f20a25] MakieCore v0.9.0</span></span>
...
<span class="line"><span>  [7269a6da] MeshIO v0.5.2</span></span>
...
<span class="line"><span>  [872c559c] NNlib v0.9.27</span></span>
<span class="line"><span>  [77ba4419] NaNMath v1.0.3</span></span>
...
<span class="line"><span>  [d8793406] ObjectFile v0.4.3</span></span>
<span class="line"><span>  [510215fc] Observables v0.5.5</span></span>
<span class="line"><span>  [6fe1bfb0] OffsetArrays v1.15.0</span></span>
<span class="line"><span>  [52e1d378] OpenEXR v0.3.3</span></span>
<span class="line"><span>  [3bd65402] Optimisers v0.4.4</span></span>
<span class="line"><span>  [bac558e1] OrderedCollections v1.7.0</span></span>
<span class="line"><span>  [bbf590c4] OrdinaryDiffEqCore v1.15.0</span></span>
<span class="line"><span>  [b1df2697] OrdinaryDiffEqTsit5 v1.1.0</span></span>
<span class="line"><span>  [90014a1f] PDMats v0.11.32</span></span>
...
<span class="line"><span>  [d236fae5] PreallocationTools v0.4.24</span></span>
...
<span class="line"><span>  [731186ca] RecursiveArrayTools v3.27.4</span></span>
...
<span class="line"><span>  [0bca4576] SciMLBase v2.71.4</span></span>
...
<span class="line"><span>  [a759f4b9] TimerOutputs v0.5.26</span></span>
...
<span class="line"><span>⌃ [e88e6eb3] Zygote v0.6.75</span></span>
<span class="line"><span>  [700de1a5] ZygoteRules v0.2.7</span></span>
<span class="line"><span>  [6e34b625] Bzip2_jll v1.0.8+4</span></span>
...
<span class="line"><span>  [7cc45869] Enzyme_jll v0.0.172+0</span></span>
<span class="line"><span>  [2702e6a9] EpollShim_jll v0.0.20230411+1</span></span>
<span class="line"><span>  [2e619515] Expat_jll v2.6.4+3</span></span>
<span class="line"><span>⌅ [b22a6f82] FFMPEG_jll v6.1.2+0</span></span>
<span class="line"><span>  [f5851436] FFTW_jll v3.3.10+3</span></span>
<span class="line"><span>  [a3f928ae] Fontconfig_jll v2.15.0+0</span></span>
<span class="line"><span>  [d7e528f0] FreeType2_jll v2.13.3+1</span></span>
<span class="line"><span>  [559328eb] FriBidi_jll v1.0.16+0</span></span>
...
<span class="line"><span>  [f8c6e375] Git_jll v2.47.1+0</span></span>
<span class="line"><span>  [7746bdde] Glib_jll v2.82.4+0</span></span>
<span class="line"><span>  [3b182d85] Graphite2_jll v1.3.14+1</span></span>
<span class="line"><span>  [2e76f6c2] HarfBuzz_jll v8.5.0+0</span></span>
<span class="line"><span>  [e33a78d0] Hwloc_jll v2.11.2+3</span></span>
...
<span class="line"><span>  [4b2f31a3] Libmount_jll v2.40.3+0</span></span>
<span class="line"><span>  [89763e89] Libtiff_jll v4.7.1+0</span></span>
<span class="line"><span>  [38a345b3] Libuuid_jll v2.40.3+0</span></span>
...
<span class="line"><span>  [458c3c95] OpenSSL_jll v3.0.15+3</span></span>
...
<span class="line"><span>  [36c8627f] Pango_jll v1.55.5+0</span></span>
...
<span class="line"><span>  [aed1982a] XSLT_jll v1.1.42+0</span></span>
<span class="line"><span>  [ffd25f8a] XZ_jll v5.6.4+0</span></span>
...
<span class="line"><span>  [c5fb5394] Xorg_xtrans_jll v1.5.1+0</span></span>
<span class="line"><span>  [3161d3a3] Zstd_jll v1.5.7+0</span></span>
...
<span class="line"><span>  [b53b4c65] libpng_jll v1.6.45+1</span></span>
