import{_ as s,c as a,o as t,a6 as n}from"./chunks/framework.DpS6FyRF.js";const i="/IncompressibleNavierStokes.jl/dev/assets/ooiueku.MCdy6iP9.png",p="/IncompressibleNavierStokes.jl/dev/assets/wnzgrtg.DQ4Nvpb1.png",l="/IncompressibleNavierStokes.jl/dev/assets/mniilii.BOckA-lV.png",e="/IncompressibleNavierStokes.jl/dev/assets/hzmkkcl.CFFxulAy.png",F=JSON.parse('{"title":"Unsteady actuator case - 2D","description":"","frontmatter":{},"headers":[],"relativePath":"generated/Actuator2D.md","filePath":"generated/Actuator2D.md","lastUpdated":null}'),h={name:"generated/Actuator2D.md"},k=n(`<h1 id="Unsteady-actuator-case-2D" tabindex="-1">Unsteady actuator case - 2D <a class="header-anchor" href="#Unsteady-actuator-case-2D" aria-label="Permalink to &quot;Unsteady actuator case - 2D {#Unsteady-actuator-case-2D}&quot;">​</a></h1><p>In this example, an unsteady inlet velocity profile at encounters a wind turbine blade in a wall-less domain. The blade is modeled as a uniform body force on a thin rectangle.</p><p>We start by loading packages. A <a href="https://github.com/JuliaPlots/Makie.jl" target="_blank" rel="noreferrer">Makie</a> plotting backend is needed for plotting. <code>GLMakie</code> creates an interactive window (useful for real-time plotting), but does not work when building this example on GitHub. <code>CairoMakie</code> makes high-quality static vector-graphics plots.</p><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">using</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> CairoMakie</span></span>
