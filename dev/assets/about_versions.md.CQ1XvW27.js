import{_ as s,c as n,o as a,a7 as p}from"./chunks/framework.NoRTQVDn.js";const u=JSON.parse('{"title":"Package versions","description":"","frontmatter":{},"headers":[],"relativePath":"about/versions.md","filePath":"about/versions.md","lastUpdated":null}'),l={name:"about/versions.md"},e=p(`<h1 id="Package-versions" tabindex="-1">Package versions <a class="header-anchor" href="#Package-versions" aria-label="Permalink to &quot;Package versions {#Package-versions}&quot;">​</a></h1><h2 id="Julia-version" tabindex="-1">Julia version <a class="header-anchor" href="#Julia-version" aria-label="Permalink to &quot;Julia version {#Julia-version}&quot;">​</a></h2><p>The examples were generated with the following Julia version:</p><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">using</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> InteractiveUtils</span></span>
...
<span class="line"><span>  [47edcb42] ADTypes v1.6.1</span></span>
...
<span class="line"><span>  [35492f91] AdaptivePredicates v1.1.1</span></span>
...
<span class="line"><span>  [159f3aea] Cairo v1.0.5</span></span>
<span class="line"><span>  [13f3f980] CairoMakie v0.12.5</span></span>
<span class="line"><span>  [49dc2e85] Calculus v0.5.1</span></span>
<span class="line"><span>  [082447d4] ChainRules v1.69.0</span></span>
...
<span class="line"><span>  [944b1d66] CodecZlib v0.7.5</span></span>
...
<span class="line"><span>  [34da2185] Compat v4.15.0</span></span>
<span class="line"><span>  [b0b7db55] ComponentArrays v0.15.16</span></span>
...
<span class="line"><span>  [927a84f5] DelaunayTriangulation v1.1.1</span></span>
<span class="line"><span>  [163ba53b] DiffResults v1.1.0</span></span>
<span class="line"><span>  [b552c78f] DiffRules v1.15.1</span></span>
<span class="line"><span>  [8d63f2c5] DispatchDoctor v0.4.12</span></span>
...
<span class="line"><span>  [fa6b7ba4] DualNumbers v0.6.8</span></span>
<span class="line"><span>  [4e289a0a] EnumX v1.0.4</span></span>
<span class="line"><span>  [f151be2c] EnzymeCore v0.7.7</span></span>
<span class="line"><span>  [429591f6] ExactPredicates v2.2.8</span></span>
<span class="line"><span>  [318dbb63] Examples v0.1.0 \`~/work/IncompressibleNavierStokes.jl/IncompressibleNavierStokes.jl/examples\`</span></span>
<span class="line"><span>  [411431e0] Extents v0.1.3</span></span>
...
<span class="line"><span>  [663a7486] FreeTypeAbstraction v0.10.3</span></span>
...
<span class="line"><span>  [0c68f7d7] GPUArrays v10.3.0</span></span>
<span class="line"><span>  [46192b85] GPUArraysCore v0.1.6</span></span>
<span class="line"><span>  [cf35fbd7] GeoInterface v1.3.5</span></span>
...
<span class="line"><span>  [34004b35] HypergeometricFunctions v0.3.23</span></span>
...
<span class="line"><span>  [82e4d734] ImageIO v0.6.8</span></span>
<span class="line"><span>  [bc367c6b] ImageMetadata v0.9.9</span></span>
<span class="line"><span>  [5e318141] IncompressibleNavierStokes v0.6.0 \`~/work/IncompressibleNavierStokes.jl/IncompressibleNavierStokes.jl\`</span></span>
...
<span class="line"><span>  [d1acc4aa] IntervalArithmetic v0.22.14</span></span>
...
<span class="line"><span>  [033835bb] JLD2 v0.4.51</span></span>
...
<span class="line"><span>  [63c18a36] KernelAbstractions v0.9.22</span></span>
<span class="line"><span>  [5ab0869b] KernelDensity v0.6.9</span></span>
<span class="line"><span>  [929cbde3] LLVM v8.0.0</span></span>
...
<span class="line"><span>  [b2108857] Lux v0.5.62</span></span>
<span class="line"><span>  [bb33d45b] LuxCore v0.1.23</span></span>
<span class="line"><span>  [34f89e08] LuxDeviceUtils v0.1.26</span></span>
<span class="line"><span>  [82251201] LuxLib v0.3.39</span></span>
<span class="line"><span>  [7e8f7934] MLDataDevices v1.0.0</span></span>
<span class="line"><span>  [1914dd2f] MacroTools v0.5.13</span></span>
<span class="line"><span>  [ee78f7c6] Makie v0.21.5</span></span>
<span class="line"><span>  [20f20a25] MakieCore v0.8.4</span></span>
...
<span class="line"><span>  [0a4f8689] MathTeXEngine v0.6.1</span></span>
...
<span class="line"><span>  [872c559c] NNlib v0.9.21</span></span>
<span class="line"><span>  [77ba4419] NaNMath v1.0.2</span></span>
<span class="line"><span>  [f09324ee] Netpbm v1.1.1</span></span>
<span class="line"><span>  [099dac27] NeuralClosure v0.1.0 \`~/work/IncompressibleNavierStokes.jl/IncompressibleNavierStokes.jl/lib/NeuralClosure\`</span></span>
...
<span class="line"><span>  [995b91a9] PlotUtils v1.4.1</span></span>
...
<span class="line"><span>  [1fd47b50] QuadGK v2.10.1</span></span>
...
<span class="line"><span>  [79098fc4] Rmath v0.7.1</span></span>
<span class="line"><span>  [5eaf0fd0] RoundingEmulator v0.2.1</span></span>
<span class="line"><span>  [fdea26ae] SIMD v3.5.0</span></span>
...
<span class="line"><span>  [0d7ed370] StaticArrayInterface v1.5.1</span></span>
...
<span class="line"><span>  [4c63d2b9] StatsFuns v1.3.1</span></span>
...
<span class="line"><span>  [731e570b] TiffImages v0.10.0</span></span>
<span class="line"><span>  [3bb67fe8] TranscodingStreams v0.11.1</span></span>
...
<span class="line"><span>  [d80eeb9a] UnsafeAtomicsLLVM v0.1.5</span></span>
<span class="line"><span>  [4004b06d] VTKBase v1.0.1</span></span>
<span class="line"><span>  [3d5dd08c] VectorizationBase v0.21.70</span></span>
<span class="line"><span>  [d49dbf32] WeightInitializers v1.0.0</span></span>
<span class="line"><span>  [efce3f68] WoodburyMatrices v1.0.0</span></span>
<span class="line"><span>  [64499a7a] WriteVTK v1.19.2</span></span>
<span class="line"><span>  [ddb6d928] YAML v0.4.12</span></span>
<span class="line"><span>  [e88e6eb3] Zygote v0.6.70</span></span>
...
<span class="line"><span>  [83423d85] Cairo_jll v1.18.0+2</span></span>
...
<span class="line"><span>  [b22a6f82] FFMPEG_jll v6.1.1+0</span></span>
<span class="line"><span>  [f5851436] FFTW_jll v3.3.10+0</span></span>
...
<span class="line"><span>  [0656b61e] GLFW_jll v3.4.0+0</span></span>
<span class="line"><span>  [78b55507] Gettext_jll v0.21.0+0</span></span>
<span class="line"><span>  [f8c6e375] Git_jll v2.44.0+2</span></span>
<span class="line"><span>  [7746bdde] Glib_jll v2.80.2+0</span></span>
<span class="line"><span>  [3b182d85] Graphite2_jll v1.3.14+0</span></span>
<span class="line"><span>  [2e76f6c2] HarfBuzz_jll v2.8.1+1</span></span>
<span class="line"><span>  [905a6f67] Imath_jll v3.1.11+0</span></span>
<span class="line"><span>  [1d5cc7b8] IntelOpenMP_jll v2024.2.0+0</span></span>
<span class="line"><span>  [aacddb02] JpegTurbo_jll v3.0.3+0</span></span>
<span class="line"><span>  [c1c5ebd0] LAME_jll v3.100.2+0</span></span>
<span class="line"><span>⌅ [dad2f222] LLVMExtra_jll v0.0.30+0</span></span>
<span class="line"><span>  [1d63c593] LLVMOpenMP_jll v15.0.7+0</span></span>
<span class="line"><span>  [dd4b983a] LZO_jll v2.10.2+0</span></span>
<span class="line"><span>⌅ [e9f186c6] Libffi_jll v3.2.2+1</span></span>
<span class="line"><span>  [d4300ac3] Libgcrypt_jll v1.8.11+0</span></span>
<span class="line"><span>  [7e76a0d4] Libglvnd_jll v1.6.0+0</span></span>
<span class="line"><span>  [7add5ba3] Libgpg_error_jll v1.49.0+0</span></span>
...
<span class="line"><span>  [91d4177d] Opus_jll v1.3.2+0</span></span>
<span class="line"><span>  [36c8627f] Pango_jll v1.52.2+0</span></span>
<span class="line"><span>  [30392449] Pixman_jll v0.43.4+0</span></span>
<span class="line"><span>  [f50d1b31] Rmath_jll v0.4.2+0</span></span>
...
<span class="line"><span>  [02c8fc9c] XML2_jll v2.13.1+0</span></span>
...
<span class="line"><span>  [0ac62f75] libass_jll v0.15.1+0</span></span>
<span class="line"><span>  [f638f0a6] libfdk_aac_jll v2.0.2+0</span></span>
<span class="line"><span>  [b53b4c65] libpng_jll v1.6.43+1</span></span>
<span class="line"><span>  [075b6546] libsixel_jll v1.10.3+0</span></span>
...
<span class="line"><span>  [1270edf5] x264_jll v2021.5.5+0</span></span>
<span class="line"><span>  [dfaa095f] x265_jll v3.5.0+0</span></span>
...
<span class="line"><span>  [8bf52ea8] CRC32c</span></span>
<span class="line"><span>  [ade2ca70] Dates</span></span>
<span class="line"><span>  [8ba89e20] Distributed</span></span>
...
<span class="line"><span>  [1a1011a3] SharedArrays</span></span>
...
<span class="line"><span>Info Packages marked with ⌅ have new versions available but compatibility constraints restrict them from upgrading. To see why use \`status --outdated -m\`</span></span></code></pre></div>`,9),i=[e];function c(t,v,r,o,d,b){return a(),n("div",null,i)}const g=s(l,[["render",c]]);export{u as __pageData,g as default};
