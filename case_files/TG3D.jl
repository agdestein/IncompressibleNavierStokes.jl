...
function TG()
    ...
    grid = create_grid(T, N; Nx, Ny, Nz, xlims, ylims, zlims, stretch)
    ...
    bc_unsteady = false
    bc_type = (;
        u = (; x = (:periodic, :periodic), y = (:periodic, :periodic), z = (:periodic, :periodic)),
        v = (; x = (:periodic, :periodic), y = (:periodic, :periodic), z = (:periodic, :periodic)),
        k = (; x = (:periodic, :periodic), y = (:periodic, :periodic), z = (:periodic, :periodic)),
        e = (; x = (:periodic, :periodic), y = (:periodic, :periodic), z = (:periodic, :periodic)),
        ν = (; x = (:periodic, :periodic), y = (:periodic, :periodic), z = (:periodic, :periodic)),
    )
    ...
    bc = create_boundary_conditions(T; bc_unsteady, bc_type, u_bc, v_bc, w_bc, dudt_bc, dvdt_bc, dwdt_bc)
