...
function operator_convection_diffusion!(setup::Setup{T,2}) where {T}
    ...
    # Boundary conditions
    Su_ux_bc = bc_general(Nux_t, Nux_in, Nux_b, hx[1], hx[end])
    ...
    # Boundary conditions
    Su_uy_bc = bc_diff_stag(Nuy_t, Nuy_in, Nuy_b, hy[1], hy[end])
    ...
    # Boundary conditions
    Sv_vx_bc = bc_diff_stag(Nvx_t, Nvx_in, Nvx_b, hx[1], hx[end])
    ...
    # Boundary conditions
    Sv_vy_bc = bc_general(Nvy_t, Nvy_in, Nvy_b, hy[1], hy[end])
...
function operator_convection_diffusion!(setup::Setup{T,3}) where {T}
    ...
    # Boundary conditions
    Su_uy_bc = bc_general_stag_diff(Nuy_t, Nuy_in, Nuy_b, hy[1], hy[end])
    ...
    # Boundary conditions
    Su_uz_bc = bc_general_stag_diff(Nuz_t, Nuz_in, Nuz_b, hz[1], hz[end])
    ...
    # Boundary conditions
    Sv_vx_bc = bc_general_stag_diff(Nvx_t, Nvx_in, Nvx_b, hx[1], hx[end])
    ...
    # Boundary conditions
    Sv_vz_bc = bc_general_stag_diff(Nvz_t, Nvz_in, Nvz_b, hz[1], hz[end])
    ...
    # Boundary conditions
    Sw_wx_bc = bc_general_stag_diff(Nwx_t, Nwx_in, Nwx_b, hx[1], hx[end])
    ...
    # Boundary conditions
    Sw_wy_bc = bc_general_stag_diff(Nwy_t, Nwy_in, Nwy_b, hy[1], hy[end])
    ...
    # Boundary conditions
    Sw_wz_bc = bc_general(Nwz_t, Nwz_in, Nwz_b, hz[1], hz[end])
